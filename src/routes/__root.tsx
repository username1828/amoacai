...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AmoAçaí – Açaíteria. Peça seu açaí fresquinho com entrega rápida." },
      { name: "author", content: "AmoAçaí" },
      ...
      { name: "twitter:title", content: "AmoAçaí - Delivery" },
